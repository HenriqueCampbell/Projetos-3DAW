...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == "GET" && isset($_GET['id'])) {
        $sql = "SELECT * FROM perguntas_subjetivas WHERE id_pergunta = :id";
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $sql = "UPDATE perguntas_subjetivas 
                SET enunciado = :pergunta, resposta_modelo = :resposta 
        ...
        $stmt->execute([
            ...
            ':resposta' => $dadosEditados['resposta']
        ]);
